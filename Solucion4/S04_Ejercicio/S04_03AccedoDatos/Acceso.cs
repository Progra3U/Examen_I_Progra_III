...
namespace S04_03AccedoDatos
{
    public class Acceso
    {
        ...
        public List<Perfiles> ObtenerPerfiles(SQLSentencia objsentencia)
        {
        ...
        public List<Perfiles> ObtenerPerfilesPorUsuario(SQLSentencia objsentencia)
        {
            List<Perfiles> lstresultados = new List<Perfiles>();
            System.Data.DataTable dt = new System.Data.DataTable();
            try
